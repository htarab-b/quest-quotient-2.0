...
function Contact() {
  return (
    <div className="bg-black text-white pt-20 lg:pt-24" id='Contact'>
      <motion.h1
      ...
      className="w-full py-4 flex items-center justify-center gap-4 flex-wrap mt-2">
      ...
      <div className="max-w-screen-xl p-4 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        <p className="mt-8 text-base leading-6 text-center text-gray-400">
          © 2024 Club Inferno, All rights reserved.
        </p>
      </div>
    </div>
  )
